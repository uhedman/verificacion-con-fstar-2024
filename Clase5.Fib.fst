...
let rec fib_tail_ok' (x n : nat) : Lemma (ensures fib_tail' (fib x) (fib (x+1)) n == fib (n + x)) (decreases n) =
  if n = 0 then ()
  else fib_tail_ok' (x + 1) (n - 1)

let rec fib_tail_ok (n:nat) : Lemma (fib_tail n == fib n) 
= fib_tail_ok' 0 n
